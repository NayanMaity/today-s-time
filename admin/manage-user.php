...
$selectUser = "SELECT * FROM user WHERE user_id != '$id' AND user_show = '1'";
    ...
    <section id="dash-main" class="d-flex ">
        ...
        <div class="dash-view">
            ...
            <div class="dash-view-main">
                <h4 class="dash-view-heading">Users</h4>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($resSelUser)) : ?>
                            <tr>
                                ...
                                <td><a href="./edit-user.php?user-id=<?php echo $row['user_id']; ?>" class="table-ac-btn-1">Edit</a></td>
                                <td><a href="./delete-user.php?user-id=<?php echo $row['user_id']; ?>" class="table-ac-btn-2">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
